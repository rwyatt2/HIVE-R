 ...
 */
export function tokensToChakra(tokens) {
    return `
 ...
 */
export function tokensToMUI(tokens) {
    return `
 ...
 */
export function mapTokensToFramework(tokens, framework) {
    switch (framework) {
        case "tailwind":
        case "shadcn":
 ...
 */
export function formatTokensForPrompt(tokens, framework) {
