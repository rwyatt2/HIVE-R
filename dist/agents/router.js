 ...
 */
export function ruleBasedRoute(query) {
 ...
 */
async function tryLevel0(enhancedPrompt, messages, routeSchema) {
 ...
 */
async function tryLevel1(enhancedPrompt, messages) {
 ...
 */
async function tryLevel2(enhancedPrompt, messages, routeSchema) {
...
export const routerNode = async (state) => {
    ...
    switch (usedLevel) {
        case 0:
            routerFallbackMetrics.level0++;
            break;
        case 1:
            routerFallbackMetrics.level1++;
            break;
        case 2:
            routerFallbackMetrics.level2++;
            break;
        case 3:
            routerFallbackMetrics.level3++;
            break;
    }
